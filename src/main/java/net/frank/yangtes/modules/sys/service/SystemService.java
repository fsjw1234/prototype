...
import net.frank.yangtes.commons.security.Digests;
import net.frank.yangtes.commons.security.shiro.session.SessionDAO;
import net.frank.yangtes.commons.service.BaseService;
import net.frank.yangtes.commons.service.ServiceException;
...
import net.frank.yangtes.modules.sys.dao.MenuDao;
import net.frank.yangtes.modules.sys.dao.RoleDao;
...
//import net.frank.yangtes.modules.sys.security.SystemAuthorizingRealm;
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By "+Global.getConfig("productName")+"\r\n");
		sb.append("\r\n======================================================================\r\n");
