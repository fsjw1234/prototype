package net.frank.yangtes.modules.sys.web;
...
import net.frank.yangtes.commons.servlet.ValidateCodeServlet;
import net.frank.yangtes.commons.utils.CacheUtils;
import net.frank.yangtes.commons.utils.CookieUtils;
...
//		view += ".jsp";
	...
	public String loginFail(HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		// 验证失败清空验证码
		request.getSession().setAttribute(ValidateCodeServlet.VALIDATE_CODE, IdGenUtil.uuid());
