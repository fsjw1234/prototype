package net.frank.yangtes.commons.security.shiro.cache;
...
public class SessionCacheManager implements CacheManager {
	...
	public class SessionCache<K, V> implements Cache<K, V> {
		...
		public V get(K key) throws CacheException {
			...
			logger.debug("get {} {} {}", new Object[]{cacheKeyName, key, request != null ? request.getRequestURI() : ""});
		...
		public V put(K key, V value) throws CacheException {
			...
			if (logger.isDebugEnabled()){
				HttpServletRequest request = Servlets.getRequest();
				logger.debug("put {} {} {}", new Object[]{cacheKeyName, key, request != null ? request.getRequestURI() : ""});
			}
