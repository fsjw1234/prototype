...
<layout:blank title="图标选择">
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="#webIcon0" data-toggle="tab">Web 应用的图标</a></li>
		<li><a href="#webIcon1" data-toggle="tab">Web 应用的图标（续）</a></li>
		<li><a href="#editorIcon" data-toggle="tab">文本编辑器图标</a></li>
		<li><a href="#directionIcon" data-toggle="tab">指示方向的图标</a></li>
		<li><a href="#othersIcon" data-toggle="tab">其它图标</a></li>
	</ul>
	<div id="icons">
		<div class="tab-content">
	        <div class="tab-pane active" id="webIcon0">
				<ul class="the-icons">
			...
			<div class="tab-pane" id="webIcon1">
				<ul class="the-icons">
			...
			<div class="tab-pane" id="editorIcon">
				<ul class="the-icons">
			...
			<div class="tab-pane" id="othersIcon">
				<ul class="the-icons">
